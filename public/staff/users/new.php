...
<div id="main-content">
  ...
  <form action="new.php" method="post">
    ...
    Password<br /><p style="font-size: 8pt">* Passwords should be at least 12 characters and include at least one uppercase letter, lowercase letter, number, and symbol.</p>
