<?php
  ...
  function has_valid_password_format($value) {
    $has_uppercase_letter = preg_match('/[A-Z]/', $value);
    $has_lowercase_letter = preg_match('/[a-z]/', $value);
    $has_number = preg_match('/[0-9]/', $value);
    $has_symbol = preg_match('/[^A-Za-z0-9]/', $value);
    return $has_uppercase_letter && $has_lowercase_letter && $has_number && $has_symbol;
  }
